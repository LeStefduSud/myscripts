...
ocs_kas1='--cclock [1]300,300,450 --lock-cclock [1]1500,1500,1600 --lock-mclock [1]810 --pl [1]170,200,270'
...
ocs_zil1='--cclock [2]100,100,100 --lock-cclock [2]1000,1000,1000 --lock-mclock [2]8200,9600,9600 --mclock [2]100,100,100'
...
sudo ./rigel -a kheavyhash+zil \
    ...
    -o [2]zmp+ssl://eu1-zil.shardpool.io:5555           -u [2]zil10ej64utfe2ueczp284xw28yp73nn97pa9j9cg6 \
    -w rig01 --log-file /var/log/miner/rigel/rigel.log \
